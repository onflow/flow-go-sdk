...
Building a transaction involves setting the transaction script, passing arguments, setting the payer, the proposers and the authorizers. We will describe each of these properties. 

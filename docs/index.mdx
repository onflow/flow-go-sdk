...
_Note: This SDK is also fully compatible with the [Flow Emulator](https://docs.onflow.org/emulator/) and can be used for local development._

#### Chinese Version: [https://github.com/onflow/flow-go-sdk/blob/master/README_zh_CN.md](https://github.com/onflow/flow-go-sdk/blob/master/README_zh_CN.md)
...
Go here more [examples](https://github.com/onflow/flow-go-sdk/tree/master/examples) that use the SDK to interact with the [Flow Emulator](https://docs.onflow.org/devtools/emulator/).

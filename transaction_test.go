...
func TestTransaction_AddArgument(t *testing.T) {
	...
	t.Run("Single argument", func(t *testing.T) {
		expectedArg := cadence.String("foo")
	...
	t.Run("Multiple arguments", func(t *testing.T) {
		expectedArgA := cadence.String("foo")
...
func TestTransaction_RLPMessages(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			tx:       baseTx().AddRawArgument(jsoncdc.MustEncode(cadence.String("foo"))),
			payload:  "",
			envelope: "",
		},
		{

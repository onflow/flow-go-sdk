...
func clientTest(
	f func(t *testing.T, ctx context.Context, rpc *MockRPCClient, client *grpc.GRPCClient),
) func(t *testing.T) {
	return func(t *testing.T) {
		ctx := context.Background()
		rpc := &MockRPCClient{}
		c := grpc.NewFromRPCClient(rpc)
		f(t, ctx, rpc, c)
...
func TestClient_Ping(t *testing.T) {
	t.Run("Success", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
	...
	t.Run("Internal error", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
...
func TestClient_GetBlockHeaderByID(t *testing.T) {
	...
	t.Run("Not found error", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
		blockID := ids.New()
...
func TestClient_ExecuteScriptAtLatestBlock(t *testing.T) {
	...
	t.Run("Arguments", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
		expectedValue := cadence.NewInt(42)
		encodedValue, err := jsoncdc.Encode(expectedValue)
		require.NoError(t, err)
	...
	t.Run(
		"Invalid JSON-CDC",
		clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
			response := &access.ExecuteScriptResponse{
...
func TestClient_GetEventsForHeightRange(t *testing.T) {
	...
	t.Run(
		...
		clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *grpc.GRPCClient) {
			...
			blocks, err := c.GetEventsForHeightRange(ctx, grpc.EventRangeQuery{
				Type:        "foo",
				StartHeight: 1,
				EndHeight:   10,
			})

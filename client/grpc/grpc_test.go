...
func clientTest(
	f func(t *testing.T, ctx context.Context, rpc *MockRPCClient, client *GRPCClient),
) func(t *testing.T) {
...
func TestClient_Ping(t *testing.T) {
	t.Run("Success", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *GRPCClient) {
	...
	t.Run("Internal error", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *GRPCClient) {
...
func TestClient_GetBlockHeaderByID(t *testing.T) {
	...
	t.Run("Not found error", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *GRPCClient) {
		blockID := ids.New()
...
func TestClient_ExecuteScriptAtLatestBlock(t *testing.T) {
	...
	t.Run("Arguments", clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *GRPCClient) {
		expectedValue := cadence.NewInt(42)
		encodedValue, err := jsoncdc.Encode(expectedValue)
		require.NoError(t, err)
	...
	t.Run(
		"Invalid JSON-CDC",
		clientTest(func(t *testing.T, ctx context.Context, rpc *MockRPCClient, c *GRPCClient) {
			response := &access.ExecuteScriptResponse{

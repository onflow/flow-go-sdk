...
type Transaction struct {
	...
	//
	// A payload signature is generated over the inner portion of the transaction (TransactionDomainTag + npayload).
	//
	...
	//
	// A envelope signature is generated over the outer portion of the transaction (TransactionDomainTag + payload + payloadSignatures).
	//
	// You can find more information about transaction signatures here: https://docs.onflow.org/concepts/transaction-signing/#anatomy-of-a-transaction
...
func NewTransaction() *Transaction {
	return &Transaction{
		TransactionDomainTag: TransactionDomainTag[:],
	}
}
